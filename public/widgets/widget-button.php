	...
	function form( $instance ) {
		...
		<div id="wc-shortcodes-button-widget-<?php echo $this->number; ?>" class="wc-shortcodes-visual-manager">
			...
			<p>
				...
				<input type="text" class="wc-shortcodes-widget-option widefat" id="<?php echo $this->get_field_id('icon_left'); ?>" name="<?php echo $this->get_field_name('icon_left'); ?>" value="<?php echo $o['icon_left']; ?>" />
				<span class="wcs-description">Enter class name of <a href="http://fontawesome.io/icons/" target="_blank">Font Awesome icon</a>.</span>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id('icon_right'); ?>"><?php _e('Icon Right:') ?></label>
				<input type="text" class="wc-shortcodes-widget-option widefat" id="<?php echo $this->get_field_id('icon_right'); ?>" name="<?php echo $this->get_field_name('icon_right'); ?>" value="<?php echo $o['icon_right']; ?>" />
				<span class="wcs-description">Enter class name of <a href="http://fontawesome.io/icons/" target="_blank">Font Awesome icon</a>.</span>
			</p>
